  ...
  return (
    <div>
      <div class="mx-auto max-w-7xl px-4 md:px-8 2xl:px-16">
        ...
        <div class=" grid-cols-12 items-start gap-x-10 pb-10 pt-7 grid ">
          <div class=" col-span-12 md:col-span-7 gap-2.5 w-full">
            <ImageGallery
              showBullets={false}
              showNav={false}
              originalWidth={100}
          ...
          <div class="col-span-12 md:col-span-5 pt-8 lg:pt-0">
            ...
            <div class="py-6 ">
              <ul class="space-y-5 pb-1 text-sm">
                ...
                <li>
                  ...
                  <a
                    class="hover:text-heading transition hover:underline"
                    href="#"
                  >
                    kids
                  </a>

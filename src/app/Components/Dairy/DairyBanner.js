  ...
  return (
    <div className="relative h-screen w-full">
      <img
        ...
        src="https://pickbazar-react-rest.vercel.app/_next/image?url=https%3A%2F%2Fpickbazarlaravel.s3.ap-southeast-1.amazonaws.com%2F1344%2Fshutterstock_389040853-%25281%2529.jpg&w=1920&q=75"
        alt=""
      ...
      <div className="absolute inset-0 mt-8 flex w-full flex-col items-center justify-center p-5 text-center md:px-20 lg:space-y-10">
        <h1 class=" text-green-600 text-2xl font-bold tracking-tight text-heading lg:text-4xl xl:text-5xl">
          You Deserve To Eat Fresh
        </h1>
        <p class="text-sm text-heading lg:text-base xl:text-lg text-gray-400">
          We source the best healthy foods for you.
        </p>
